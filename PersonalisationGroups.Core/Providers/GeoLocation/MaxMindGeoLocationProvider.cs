...
namespace Our.Umbraco.PersonalisationGroups.Core.Providers.GeoLocation
{
    public class MaxMindGeoLocationProvider : IGeoLocationProvider
    {
        ...
        public MaxMindGeoLocationProvider(IOptions<PersonalisationGroupsConfig> config, IWebHostEnvironment webHostEnvironment, AppCaches appCaches)
        {
            _pathToCountryDb = webHostEnvironment.MapPathWebRoot(config.Value.GeoLocationCountryDatabasePath); 
            _pathToCityDb = webHostEnvironment.MapPathWebRoot(config.Value.GeoLocationCityDatabasePath);
